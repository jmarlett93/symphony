...
export declare const pokeSchema: import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
    user_from: import("@sinclair/typebox").TNumber;
    user_to: import("@sinclair/typebox").TNumber;
}>;
export type Poke = Static<typeof pokeSchema>;
export declare const pokeValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const pokeResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
    user_from: number;
    user_to: number;
}, HookContext<PokeService<import("./pokes.class").PokeParams>>>;
export declare const pokeExternalResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
    user_from: number;
    user_to: number;
}, HookContext<PokeService<import("./pokes.class").PokeParams>>>;
export declare const pokeDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
    user_from: import("@sinclair/typebox").TNumber;
    user_to: import("@sinclair/typebox").TNumber;
...
export declare const pokeDataValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const pokeDataResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
    user_from: number;
    user_to: number;
}, HookContext<PokeService<import("./pokes.class").PokeParams>>>;
export declare const pokePatchSchema: import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
    user_from: import("@sinclair/typebox").TNumber;
    user_to: import("@sinclair/typebox").TNumber;
...
export declare const pokePatchValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const pokePatchResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
    user_from: number;
    user_to: number;
}, HookContext<PokeService<import("./pokes.class").PokeParams>>>;
export declare const pokeQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
    user_from: import("@sinclair/typebox").TNumber;
    user_to: import("@sinclair/typebox").TNumber;
}>, ["id", "text"]>;
export declare const pokeQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
...
export declare const pokeQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const pokeQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
        id?: number | undefined;
